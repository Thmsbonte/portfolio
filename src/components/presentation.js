    ...
    <div className="presentation" style={{ height: SECTION_HEIGHT }}>
      <div className="content-left">
        ...
        <p className="presentation-text">
          Full-Stack web and mobile developer based in Paris, France. With an IT
          consulting background, I aim to offer both technical and project
          leading skills to bring about your projects.
        </p>
